...
void rqt_multiplot::PlotAxisConfigWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PlotAxisConfigWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rqt_multiplot::PlotAxisConfigWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_rqt_multiplot__PlotAxisConfigWidget.data,
    qt_meta_data_rqt_multiplot__PlotAxisConfigWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
